...
const ShippingPolicy = ({ content }) => {
    ...
    return (
        <div className="pt-32 pb-20 px-6 md:px-12 lg:px-24 max-w-5xl mx-auto min-h-screen">
            ...
            <p className="text-center text-gray-500 text-xs md:text-sm mt-8 mb-16 tracking-widest uppercase">Secure, Insured, and Discreet</p>
